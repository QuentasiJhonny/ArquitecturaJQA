...
public class Main {
    public static void main(String [] args){
       //creacion de temas 
       Temas tema1 = new Temas("Introduccion","Aprender lo basico","base1",124,72.0f);
       Temas tema2 = new Temas("Introduccion2","Aprender lo basico","base2",378,14.0f);
       Temas tema3 = new Temas("Introduccion3","Aprender lo basico","base3",24,54.0f);
       Temas tema4 = new Temas("Introduccion4","Aprender lo basico","base4",12,74.0f);
       Temas tema5 = new Temas("Introduccion5","Aprender lo basico","base5",72,84.0f);
       Temas tema6 = new Temas("Introduccion6","Aprender lo basico","base6",48,94.0f);
        Temas tema7 = new Temas("Introduccion7","Aprender lo basico","base7",12,124.0f);
       ...
       Curso curso3= new Curso("curso4");
       
       curso.addTemas(tema1);
       curso.addTemas(tema2);
       curso.addTemas(tema3);
        curso.addTemas(tema4);
       Curso curso4= new Curso("curso5");
        curso.addTemas(tema1);
       curso.addTemas(tema2);
       curso.addTemas(tema3);
        curso.addTemas(tema4);
